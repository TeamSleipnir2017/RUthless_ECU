...
void debug_init(Usart * USART_Controller, uint32_t BaudRate);

void debug_add_to_next_message(uint32_t Time, char * String, uint32_t Value); // This can be renamed to more proper name
